...
urlpatterns = [
    ...
    path('profile/<slug:slug>/', profile_view, name='profile-detail'),
    path('profile/<slug:slug>/update/', update_profile_view, name='doctor-profile-update'),
    ...
    path('wallet/<slug:slug>/', wallet_view, name='wallet-detail'),
